...
public class SeckillCodeMsg extends CodeMsg {
    ...
    public static final SeckillCodeMsg SECKILL_PRODUCT_ERROR= new SeckillCodeMsg(500208,"商品繁忙");
    public static final SeckillCodeMsg SECKILL_OPERATION_ERROR= new SeckillCodeMsg(500209,"操作错误");
    public static final SeckillCodeMsg SECKILL_TIME_ERROR= new SeckillCodeMsg(500210,"秒杀时间不对");
}
